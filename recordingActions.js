...
export const listByCategorygi = () => async (dispatch) => {
    try {
        dispatch({ type: RECORDING_CATEGORY_REQUEST })

        const { data } = await axios.get(`/api/recordings/bycategorygi/`)
...
export const listByCategorygc = () => async (dispatch) => {
    try {
        dispatch({ type: RECORDING_CATEGORY_REQUEST })

        const { data } = await axios.get(`/api/recordings/bycategorygc/`)
